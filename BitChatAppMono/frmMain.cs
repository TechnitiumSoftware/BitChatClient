...
namespace BitChatAppMono
{
    public partial class frmMain : Form, IDebug
    {
        ...
        private void mainContainer_Panel1_Resize(object sender, EventArgs e)
        {
            lstChats.Size = new Size(mainContainer.Panel1.Width, mainContainer.Panel1.Height - lstChats.Top);
        }
